# -*- coding: utf-8 -*-
"""Quick script to fix Bước 1 in Build_APK_Colab.ipynb - lần 2"""
...
for cell in nb['cells']:
    if cell.get('cell_type') == 'code':
        ...
        if any('Bước 1a' in line for line in source):
            ...
            # Source mới - fix pip (dùng uv pip install) và Java verify (dùng shell)
            new_source = [
                ...
                "# Bước 1c: Verify Python và Java (dùng shell=True để capture stderr)\n",
                "print()\n",
                ...
                "# Cài buildozer + cython bằng uv (uv pip install tự cài pip vào venv)\n",
